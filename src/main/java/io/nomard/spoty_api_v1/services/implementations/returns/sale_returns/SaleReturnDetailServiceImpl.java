...
public class SaleReturnDetailServiceImpl implements SaleReturnDetailService {
    ...
    @Override
    public List<SaleReturnDetail> getAll(int pageNo, int pageSize) {
        //create page request object
        PageRequest pageRequest = PageRequest.of(pageNo, pageSize/*, Sort.by("createdAt").descending()*/);
        //pass it to repos
        Page<SaleReturnDetail> page = saleReturnDetailRepo.findAll(pageRequest);
    ...
    public ResponseEntity<ObjectNode> save(SaleReturnDetail saleReturnDetail) {
        try {
            ...
            saleReturnDetail.setCreatedAt(new Date());
    ...
    @Override
    public ResponseEntity<ObjectNode> saveMultiple(ArrayList<SaleReturnDetail> saleReturnDetailList) {
        return null;
    }
